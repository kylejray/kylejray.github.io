...
2. On your **local machine**, you'll need to open up an ssh tunnel to port \<PORT NUMEBR\> on the **remote machine** with the following command:
...
3. We're done now.  Almost. Go to a browser on your local machine and try the URL:
